  ...
  try {
    ...
    if (!USDC_ADDRESSES[chainId]) {
      return {
        ...
        actualAmount: "0",
        actualAmountRaw: 0n,
        sender: "0x40252CFDF8B20Ed757D61ff157719F33Ec332402" as Address,
...
export async function verifyPaymentForTool(
  ...
  if (toolPrice === 0) {
    return {
      ...
      actualAmountRaw: 0n,
      sender: "0x40252CFDF8B20Ed757D61ff157719F33Ec332402" as Address,
      recipient: recipient || ("0x40252CFDF8B20Ed757D61ff157719F33Ec332402" as Address),
      blockNumber: 0n,
      transactionHash: txHash,
      chainId,
      toolName,
  ...
  if (!paymentRecipient) {
    return {
      ...
      actualAmountRaw: 0n,
      sender: "0x40252CFDF8B20Ed757D61ff157719F33Ec332402" as Address,
      recipient: "0x40252CFDF8B20Ed757D61ff157719F33Ec332402" as Address,
      blockNumber: 0n,
      transactionHash: txHash,
      chainId,
      toolName,
