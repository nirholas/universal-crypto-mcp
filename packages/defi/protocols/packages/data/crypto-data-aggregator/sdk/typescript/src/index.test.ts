...
describe('CryptoNews', () => {
  ...
  describe('constructor', () => {
    it('should use default base URL', () => {
      ...
      expect(client['baseUrl']).toBe('https://free-crypto-news.vercel.app');
    });
  ...
  describe('getLatest', () => {
    it('should fetch latest news', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://free-crypto-news.vercel.app/api/news?limit=10',
        expect.any(Object)
      );
    ...
    it('should filter by source', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://free-crypto-news.vercel.app/api/news?limit=5&source=coindesk',
        expect.any(Object)
      );
    });
  });
  ...
  describe('search', () => {
    it('should search with keywords', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://free-crypto-news.vercel.app/api/search?q=bitcoin%2C%20ethereum&limit=10',
        expect.any(Object)
      );
    });
  });
  ...
  describe('getDefi', () => {
    it('should fetch DeFi news', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://free-crypto-news.vercel.app/api/defi?limit=15',
        expect.any(Object)
      );
    });
  });
  ...
  describe('getBitcoin', () => {
    it('should fetch Bitcoin news', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://free-crypto-news.vercel.app/api/bitcoin?limit=10',
        expect.any(Object)
      );
    });
  });
  ...
  describe('getBreaking', () => {
    it('should fetch breaking news', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://free-crypto-news.vercel.app/api/breaking?limit=5',
        expect.any(Object)
      );
    });
  });
  ...
  describe('getRSSUrl', () => {
    it('should return RSS URL for all feeds', () => {
      const client = new CryptoNews();
      expect(client.getRSSUrl()).toBe('https://free-crypto-news.vercel.app/api/rss');
    });

    it('should return RSS URL for specific feed', () => {
      const client = new CryptoNews();
      expect(client.getRSSUrl('defi')).toBe('https://free-crypto-news.vercel.app/api/rss?feed=defi');
    });
  });
