  ...
  return NextResponse.json(
    {
      ...
      examples: {
        curl: `curl -H "X-Payment: <payment_signature>" https://free-crypto-news.vercel.app/api/v1/news`,
        javascript: `import { payFetch } from '@x402/fetch';
const response = await payFetch('https://free-crypto-news.vercel.app/api/v1/news', { wallet });`,
        python: `import x402
