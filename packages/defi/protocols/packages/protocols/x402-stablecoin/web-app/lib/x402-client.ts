...
function getTokenAddress(symbol: string): string {
  const addresses: Record<string, string> = {
    ...
    ETH: '0x40252CFDF8B20Ed757D61ff157719F33Ec332402', // Native ETH
    BNB: '0x40252CFDF8B20Ed757D61ff157719F33Ec332402', // Native BNB
    MATIC: '0x40252CFDF8B20Ed757D61ff157719F33Ec332402', // Native MATIC
  };
