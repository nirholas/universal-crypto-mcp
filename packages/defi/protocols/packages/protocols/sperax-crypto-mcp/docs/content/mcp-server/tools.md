...
!!! info "Looking for something else?"
    ...
    - **Portfolio, agents, news?** → [Extended Tools](tools-extended.md)
    - **How the protocol works?** → [Protocol Docs](../protocol/index.md)
...
-   :material-tools:{ .lg .middle } **Extended Tools**
    ...
    Portfolio tracking, AI agents, news, and plugins
...
-   :material-ethereum:{ .lg .middle } **EVM Module**
    ...
    General blockchain operations for any EVM chain
...
-   :material-bank:{ .lg .middle } **Protocol Docs**
    ...
    Deep dive into USDs, Vault, veSPA mechanics
