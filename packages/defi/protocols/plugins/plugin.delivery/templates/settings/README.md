...
```typescript
import { getPluginSettingsFromRequest, createErrorResponse, PluginErrorType } from '@nirholas/plugin-sdk';
...
When the user installs the plugin, Universal Crypto MCP shows a settings form based on your schema.
