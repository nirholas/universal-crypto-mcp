 ...
 * contracts Types
 *
 * Auto-extracted from vendor/contracts/
 */
...
type Result = FormatAbiParameter<{ type: 'address';
 ...
 * @example
 * const abi = parseAbi([
 *   //  ^? const abi: readonly [{ name: "balanceOf";
...
export interface Contract {
  // TODO: Define based on vendor/contracts/ patterns
}
