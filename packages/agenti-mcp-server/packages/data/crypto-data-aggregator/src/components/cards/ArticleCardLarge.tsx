...
const defaultStyle = {
  gradient: 'from-surface-hover via-surface to-background',
  ...
  glow: 'group-hover:shadow-surface-hover/30',
};
...
function ArticleCardLarge({ article, externalLink = false }: ArticleCardLargeProps) {
  ...
  const cardClasses = [
    ...
    style.glow,
    'border border-surface-border hover:border-primary/50',
  ...
  const categoryClasses =
    'inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-full bg-surface-hover text-text-primary';
    ...
    <article className="group">
      <CardWrapper {...linkProps} className={cardClasses}>
        <div className="relative w-full md:w-[45%] h-[200px] md:h-full flex-shrink-0 overflow-hidden">
          ...
          <div
            className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-surface to-transparent md:hidden"
            aria-hidden="true"
          />
          <div
            className="absolute top-0 bottom-0 right-0 w-24 bg-gradient-to-l from-surface to-transparent hidden md:block"
            aria-hidden="true"
          />
        </div>
        ...
        <div className="flex-1 p-6 md:p-8 flex flex-col justify-between">
          <div>
            ...
            <h3 className="text-xl md:text-2xl font-extrabold text-text-primary group-hover:text-primary transition-colors duration-300 line-clamp-2 leading-tight mb-4">
              {article.title}
            </h3>
            {article.description && (
          ...
          <div className="flex items-center justify-between pt-5 border-t border-surface-border mt-4">
            ...
            <div className="flex items-center gap-2 font-bold text-primary group-hover:text-primary/80 transition-colors">
