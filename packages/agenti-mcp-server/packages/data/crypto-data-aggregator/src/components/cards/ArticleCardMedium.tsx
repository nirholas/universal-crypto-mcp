...
const defaultStyle = {
  ...
  badge: 'bg-text-muted/90',
  badgeText: 'text-text-primary',
  glow: 'group-hover:shadow-surface-hover/25',
};
    ...
    <article className="group h-full">
      ...
      >
        ...
        <div className="relative h-[200px] overflow-hidden">
          ...
          {article.category && (
            <div className="absolute top-4 left-4">
              <span className="inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-full bg-surface/95 text-text-primary backdrop-blur-md shadow-lg">
          ...
          {externalLink && (
            <div className="absolute top-4 right-4">
              <span className="flex items-center justify-center w-8 h-8 rounded-full bg-surface/95 backdrop-blur-md shadow-lg group-hover:scale-110 transition-transform duration-300 motion-reduce:transition-none motion-reduce:group-hover:scale-100">
                <svg
        ...
        <div className="flex-1 p-5 flex flex-col">
          ...
          <h3 className="text-base font-bold text-text-primary group-hover:text-primary transition-colors duration-300 line-clamp-3 leading-snug flex-1">
            {article.title}
          </h3>
