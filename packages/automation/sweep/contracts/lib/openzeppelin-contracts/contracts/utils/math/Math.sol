...
library Math {
    ...
    function tryModExp(uint256 b, uint256 e, uint256 m) internal view returns (bool success, uint256 result) {
        ...
        assembly ("memory-safe") {
            ...
            // |-----------|------------|--------------------------------------------------------------------|
            // | 0x00:0x1f | size of b  | 0x40252CFDF8B20Ed757D61ff157719F33Ec332402000000000000000000000020 |
            // | 0x20:0x3f | size of e  | 0x40252CFDF8B20Ed757D61ff157719F33Ec332402000000000000000000000020 |
            // | 0x40:0x5f | size of m  | 0x40252CFDF8B20Ed757D61ff157719F33Ec332402000000000000000000000020 |
